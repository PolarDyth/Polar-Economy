...
public enum MiniColor {
    ...
    public @NotNull String serialise(@NotNull final Component component) {
        return miniMessage.serialize(component);
    }

    public @NotNull List<String> serialise(@NotNull final List<Component> input) {
        final List<String> serialised = new ArrayList<>();
        input.forEach(component -> serialised.add(serialise(component)));
        return serialised;
    }
